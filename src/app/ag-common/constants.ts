...
export const PRO_FORMA_REPORT_BOOKING_SEARCH_TEXT_LENGTH = 3;
...
export const COMMENT_TEMPLATE_COMMENTS_MAXLENGTH = 4000;
...
export enum ErrorCodes {
    ...
    PROPERTY_CONTACT_NOT_AVAILABLE= 411734
...
export const TASK_LISTORDER_MAXLENGTH = 5;
...
export const TASK_LIMIT_EXCEEDED = 442309;
...
export const MAX_DATE_DIFFERENCE=7;

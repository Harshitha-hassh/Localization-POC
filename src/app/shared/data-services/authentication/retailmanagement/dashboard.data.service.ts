...
import { TransactionDetails, OutOfStock, DonutCount } from 'src/app/home/dashboard-widgets-report/dashboard.modal';
...
export class DashBoardService {
    ...
    //         { route: GolfApiRoute.GetItemSaleDetail, uriParams: { startDate: _startDate, endDate: _endDate} , body: outletIds  });
    //     return result;
    // } 
    ...
    //         { route: GolfApiRoute.GetCategorySaleDetail, uriParams: { startDate: _startDate, endDate: _endDate} , body: outletIds  });
    //     return result;
    // } 
    ...
    //         { route: GolfApiRoute.GetOutletSaleDetail, uriParams: { startDate: _startDate, endDate: _endDate} , body: outletIds  });
    //     return result;
    // }
    ...
    //         { route: GolfApiRoute.GetTransactionSaleDetail, uriParams: { startDate: _startDate, dataFormat: dataFormat} , body: outletIds  });
    //     return result;
    // }
}
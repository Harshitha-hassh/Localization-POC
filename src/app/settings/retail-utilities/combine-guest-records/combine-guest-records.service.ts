...
headerGenerator() {
  return [
    ...
    {
    displayNameId: 'tbl_hdr_initial',
      displayName: this.captions.tbl_hdr_initial,
      key: 'initial',
      searchable: false,
      sorting: true,
      sortingKey: 'initial',
    ...
    {
    displayNameId: 'tbl_hdr_company',
      displayName: this.captions.tbl_hdr_company,
      key: 'company',
      searchable: false,
      sorting: false,
      sortingKey: 'company',
    ...
    {
    displayNameId: 'lbl_CompanyID',
      displayName: this.captions.lbl_CompanyID,
      key: 'companyid',
      searchable: false,
      sorting: false,
